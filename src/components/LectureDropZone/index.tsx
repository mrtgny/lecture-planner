  ...
  return (
    <div
      ...
      className={classNames(
        "flex justify-center items-center border-[1px] min-w-[200px] min-h-[100px]",
        {
    ...
    >
      ...
      <Show
        showIf={!(!dayIndex && !!lectureIndex) && !lectureIndex && !!dayIndex}
      >
        {time}
      </Show>
      <Show
        showIf={
          !(!(!dayIndex && !!lectureIndex) && !lectureIndex && !!dayIndex) &&
          !!lecture
        }
      >
        <Lecture
